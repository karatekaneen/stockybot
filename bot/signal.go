...
type signalRepository interface {
	...
	PriceData(ctx context.Context, id string) (*stockybot.PriceDocument, error)
}
...
func interactionResponse(s *discordgo.Session, i *discordgo.InteractionCreate, content string) error {
